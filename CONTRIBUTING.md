# Contributing to nanocustomassert
...
Fork the project [on GitHub](https://github.com/geut/nanocustomassert) and check out your copy locally.

```bash
$ git clone git@github.com:username/nanocustomassert.git
$ cd nanocustomassert
$ npm install
$ git remote add upstream git://github.com/geut/nanocustomassert.git
```
